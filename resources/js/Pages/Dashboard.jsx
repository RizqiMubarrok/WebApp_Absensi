            ...
            <div className="py-6 w-full px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-gray-50 rounded-xl p-6 mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-6 gap-6 items-stretch">
                        ...
                        {/* Kehadiran (right) */}
                        <div className="md:col-span-4 grid grid-cols-2 md:grid-cols-3 gap-6">
                            <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center justify-center">
                                <div className="w-12 h-12 rounded-lg flex items-center justify-center bg-blue-50 text-blue-600 mb-3 text-lg">
                                    ✓
                                </div>
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-md flex flex-col items-center justify-center">
                                <div className="w-12 h-12 rounded-lg flex items-center justify-center bg-yellow-50 text-yellow-600 mb-3 text-lg">
                                    i
                                </div>
                                <div className="text-sm text-gray-500">
                                    Izin
